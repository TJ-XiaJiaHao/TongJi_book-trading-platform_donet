...
typedef struct _MSGBUS_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } MSGBUS_MIDL_TYPE_FORMAT_STRING;

typedef struct _MSGBUS_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } MSGBUS_MIDL_PROC_FORMAT_STRING;

typedef struct _MSGBUS_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } MSGBUS_MIDL_EXPR_FORMAT_STRING;
...
extern const MSGBUS_MIDL_TYPE_FORMAT_STRING MSGBUS__MIDL_TypeFormatString;
extern const MSGBUS_MIDL_PROC_FORMAT_STRING MSGBUS__MIDL_ProcFormatString;
extern const MSGBUS_MIDL_EXPR_FORMAT_STRING MSGBUS__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IMSGBUS_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IMSGBUS_ProxyInfo;
...
static const MSGBUS_MIDL_PROC_FORMAT_STRING MSGBUS__MIDL_ProcFormatString =
    {
        0,
        {
...
static const MSGBUS_MIDL_TYPE_FORMAT_STRING MSGBUS__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    MSGBUS__MIDL_ProcFormatString.Format,
...
/* Object interface: IMSGBUS, ver. 0.0,
   GUID={0xA05F6F3A,0xB773,0x4851,{0x9A,0xC5,0x24,0x28,0x10,0x03,0xE0,0xCE}} */

#pragma code_seg(".orpc")
static const unsigned short IMSGBUS_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IMSGBUS_ProxyInfo =
    {
    &Object_StubDesc,
    MSGBUS__MIDL_ProcFormatString.Format,
    &IMSGBUS_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IMSGBUS_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    MSGBUS__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _IMSGBUSProxyVtbl = 
{
    &IMSGBUS_ProxyInfo,
    &IID_IMSGBUS,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IMSGBUS::getMsg */ ,
    (void *) (INT_PTR) -1 /* IMSGBUS::getError */ ,
    (void *) (INT_PTR) -1 /* IMSGBUS::getInfo */
};


static const PRPC_STUB_FUNCTION IMSGBUS_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IMSGBUSStubVtbl =
{
    &IID_IMSGBUS,
    &IMSGBUS_ServerInfo,
    10,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    MSGBUS__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _MSGBUS_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IMSGBUSProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _MSGBUS_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IMSGBUSStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _MSGBUS_InterfaceNamesList[] = 
{
    "IMSGBUS",
    "IComponentRegistrar",
    0
...
const IID *  const _MSGBUS_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _MSGBUS_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _MSGBUS, pIID, n)

int __stdcall _MSGBUS_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _MSGBUS, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _MSGBUS, 2, *pIndex )
    
}

const ExtendedProxyFileInfo MSGBUS_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _MSGBUS_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _MSGBUS_StubVtblList,
    (const PCInterfaceName * ) & _MSGBUS_InterfaceNamesList,
    (const IID ** ) & _MSGBUS_BaseIIDList,
    & _MSGBUS_IID_Lookup, 
    2,
    2,
