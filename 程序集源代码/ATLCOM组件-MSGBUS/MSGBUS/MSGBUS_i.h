...
#ifndef __MSGBUS_i_h__
#define __MSGBUS_i_h__
...
#ifndef __IMSGBUS_FWD_DEFINED__
#define __IMSGBUS_FWD_DEFINED__
typedef interface IMSGBUS IMSGBUS;

#endif 	/* __IMSGBUS_FWD_DEFINED__ */
...
#ifndef __MSGBUS_FWD_DEFINED__
#define __MSGBUS_FWD_DEFINED__

#ifdef __cplusplus
typedef class MSGBUS MSGBUS;
#else
typedef struct MSGBUS MSGBUS;
#endif /* __cplusplus */

#endif 	/* __MSGBUS_FWD_DEFINED__ */
...
#ifndef __IMSGBUS_INTERFACE_DEFINED__
#define __IMSGBUS_INTERFACE_DEFINED__

/* interface IMSGBUS */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IMSGBUS;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("A05F6F3A-B773-4851-9AC5-24281003E0CE")
    IMSGBUS : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE getMsg( 
            /* [in] */ LONG id,
            /* [retval][out] */ BSTR *msg) = 0;
    ...
    typedef struct IMSGBUSVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *getMsg )( 
            IMSGBUS * This,
            /* [in] */ LONG id,
            /* [retval][out] */ BSTR *msg);
    ...
    interface IMSGBUS
    {
        CONST_VTBL struct IMSGBUSVtbl *lpVtbl;
    };
...
#define IMSGBUS_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IMSGBUS_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IMSGBUS_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IMSGBUS_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IMSGBUS_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IMSGBUS_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IMSGBUS_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IMSGBUS_getMsg(This,id,msg)	\
    ( (This)->lpVtbl -> getMsg(This,id,msg) ) 

#define IMSGBUS_getError(This,id,msg)	\
    ( (This)->lpVtbl -> getError(This,id,msg) ) 

#define IMSGBUS_getInfo(This,id,msg)	\
    ( (This)->lpVtbl -> getInfo(This,id,msg) ) 
...
#endif 	/* __IMSGBUS_INTERFACE_DEFINED__ */



#ifndef __MSGBUSLib_LIBRARY_DEFINED__
#define __MSGBUSLib_LIBRARY_DEFINED__

/* library MSGBUSLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_MSGBUSLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("77142EDE-6E71-4193-A4EE-FF583762EF8F")
CompReg;
#endif

EXTERN_C const CLSID CLSID_MSGBUS;

#ifdef __cplusplus

class DECLSPEC_UUID("14195B27-E7FE-44FB-8600-AA3B147FCDFF")
MSGBUS;
#endif
#endif /* __MSGBUSLib_LIBRARY_DEFINED__ */
